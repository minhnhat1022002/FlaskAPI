...
class CombiGCN(object):
    ...
    def _create_combigcn_embed(self):
        ...
        for k in range(0, self.n_layers):
            users_embed, items_embed = tf.split(ego_embeddings, [self.n_users, self.n_items], 0)
            ...
            users_embed_next, items_embed_interaction = tf.split(side_embeddings, [self.n_users, self.n_items],
                                                                 0)
            ...
            side_embeddings = tf.concat([users_embed_next, items_embed_next], axis=0)
    ...
    *********************************************************
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        *********************************************************
        ...
        cur_best_pre_0, stopping_step, should_stop = early_stopping(ret['recall'], cur_best_pre_0,
        ...
        if ret['recall'][0] == cur_best_pre_0[0] and args.save_flag == 1:

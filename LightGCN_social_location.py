...
class LightGCN(object):
    ...
    def _create_lightgcn_embed(self):
        ...
        SI_fold_hat = self._split_U_hat(self.social_adj)
        ...
        for k in range(0, self.n_layers):
            ...
            fusion_embed_users = [user_embed_interaction, users_embed_similar]
            fusion_embed_users = tf.stack(fusion_embed_users, 1)
            users_embed_next = tf.reduce_sum(fusion_embed_users, axis=1, keepdims=False)

            fusion_embed_items = [items_embed_interaction, items_embed_distance]
